<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @canany(['food:read', 'foodCategory:read'])
                            ...
                            <x-jet-dropdown align="right" width="60">
                                ...
                                <x-slot name="content">
                                    <div class="w-40">
                                        ...
                                        @endcan
                                        @can('foodCategory:read')
                                            <x-jet-dropdown-link href="{{ route('foodCategory.index') }}">
                                                {{ __('Categories') }}
                                            </x-jet-dropdown-link>
                                        @endcan
                                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('workSchedule.index') }}"
                :active="request()->routeIs('workSchedule.index')">
                {{ __('Work Schedule') }}
            </x-jet-responsive-nav-link>
        </div>
